...
@section('title', 'Course Details | Madridejos Community College')
  ...
  <main class="main">
    ...
    <section id="courses-course-details" class="courses-course-details section">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            <img src="assets/img/1000x450.png" class="img-fluid" alt="">
          ...
          <div class="col-lg-4">
            ...
            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Department Head/Dean</h5>
              <p><a href="instructor-detail">Sampalik Laguna</a></p>
            </div>
